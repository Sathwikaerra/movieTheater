...
<button className='p-2 bg-black text-white rounded-lg hover:bg-violet-500 hover:text-white ' onClick={()=>{navigate('/updateuser')}}>Update User Details</button>
      ...
      <div className='flex flex-col justify-center items-center'>
        <div>
          ...
          <h1 className=' mb-[20px] font-bold text-xl text-center text-black shadow-neutral-50 shadow-2xl '>{ bookings && bookings.length>0 ?"_______Bookings_______":"_______No Bookings yet_______"}</h1>
